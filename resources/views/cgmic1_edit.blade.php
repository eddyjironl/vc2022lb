...
@section("contenido")
    <form action="{{ route('actualizar_cgmic1',$odata) }}" method="POST">
        <div class="contenedor mb-2 barra_info mt-4">
            ...
            <a href="{{ route('cgmic1')}}"  class="btn btn-warning mt-3 btn-sm" >volver</a>
        </div>
        ...
        <div class="container">
            <div class="form-group">
                ...
                <input type="text" name="cmic1no" id="cmic1no" class="form-control" readonly value="{{ $odata->cmic1no }}" placeholder="Indique un codigo">
